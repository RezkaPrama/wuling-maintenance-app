...
function loadExistingPurchaseData() {
    ...
    fetch(`/api/v1/purchases-return/${purchaseId}/details`, {
        headers: {
...
function initializeEventListeners() {
    ...
    // Form submission
    document.getElementById('purchase-return-form').addEventListener('submit', handleFormSubmit);
}
...
//     formData.append('status', 'Retur Sudah Terbuat');
...
//     // Send request
//     fetch(`/admin/manufacture/purchases-return/${purchaseId}`, {
//         method: 'POST',
//         headers: {
...
//                 icon: 'success',
//                 title: 'Success!',
//                 text: result.message || 'Retur Pembelian Berhasil di edit',
//                 confirmButtonText: 'OK'
//             }).then(() => {
//                 window.location.href = '/admin/manufacture/purchases-return';
//             });
//         } else {
