...
function addProductToCart(product) {
    ...
    if (existingItemIndex !== -1) {
        ...
        // ✅ Update dengan highlighting dan pindah ke atas
        ...
        // ✅ Add dengan highlighting di posisi paling atas
    ...
    updateCartSummary();
    // ✅ COMMENT atau HAPUS sortCartTableOptimized() jika tidak ingin sorting
...
function updateCartRowOptimized(item, isNew = false) {
    ...
    const updates = [
        ...
        { selector: '.hpp-subtotal-value', value: formatMoney(item.hpp_subtotal), isText: true },
        ...
        { selector: `input[name="products[${item.id_product}][hpp_subtotal]"]`, value: item.hpp_subtotal }
    ];
