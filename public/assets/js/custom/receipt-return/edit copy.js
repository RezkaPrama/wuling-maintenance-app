...
function addProductToCart(product) {
    ...
    if (existingItemIndex !== -1) {
        ...
        const newItem = {
            ...
            barcode: product.barcode || '',  // ✅ Handle undefined
            product_name: product.name || product.product_name || 'Produk Tidak Dikenal',  // ✅ FIX: gunakan 'name' dari API
            price_sell: product.price_sell || 0,  // ✅ Handle undefined
            quantity: product.quantity || 0,  // ✅ Handle undefined
            price_pcs: price,
            hpp_pcs: hpp,
            qty: 1,
            subtotal: price,
