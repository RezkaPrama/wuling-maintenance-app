<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo" style="background-color: #fff;">
        ...
        <a href="../../demo1/dist/index.html">
            <img alt="Logo" src="{{ asset('assets/media/logos/logo.png') }}" class="h-55px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                {{-- start Menu equipment --}}
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/equipment*') ? ' active' : '' }}"
                        href="{{ route('admin.equipment.index') }}" title="Menu Equipment" data-bs-toggle="tooltip"
                ...
                {{-- start Check Sheet --}}
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/admin/check-sheet/templates*') ? ' active' : '' }}"
                        href="{{ route('admin.check-sheet.template.index') }}" title="Menu Check Sheet"
                ...
                {{-- start Menu Schedule PM --}}
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/schedules*') ? ' active' : '' }}"
                        href="{{ route('admin.schedules.index') }}" title="Menu Master Pelanggan"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">`
                            <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                        ...
                        <span class="menu-title">Schedule PM</span>
                    </a>
                </div>
                {{-- end Menu Schedule PM --}}

                {{-- start Menu Maintenance Record --}}
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/records*') ? ' active' : '' }}"
                        href="{{ route('admin.records.index') }}" title="Menu Master Pelanggan"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">`
                            <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                ...
                {{-- end Menu Maintenance Record --}}

                {{-- start Menu Manufaktur --}}
                {{-- <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    @can('pembelian manufaktur.index')
                                        <div class="menu-item">
                                            <a class="menu-link {{ Request::is('purchases/*') ? ' active' : '' }}"
                                                href="{{ route('purchases.index') }}" title="Pembelian Bahan Baku"
                                                data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                                data-bs-placement="right">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                    ...
                                    @can('pembelian manufaktur.logistics_approval')
                                        <div class="menu-item">
                                            <a class="menu-link {{ Request::is('purchases/*') ? ' active' : '' }}"
                                                href="{{ route('purchases-verification.index') }}"
                                                title="Verifikasi Terima Barang Pembelian Bahan Baku"
                                                data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                                data-bs-placement="right">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Verifikasi Penerimaan </span>
                                            </a>
                                        </div>
                                    @endcan

                                    @can('returpembelian manufaktur.index')
                                        <div class="menu-item">
                                            <a class="menu-link {{ Request::is('admin/purchases-return/*') ? ' active' : '' }}"
                                                href="{{ route('purchases-return.index') }}"
                                                title="Retur Pembelian Bahan Baku" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-dismiss="click"
                                                data-bs-placement="right">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Retur Pembelian </span>
                                            </a>
                                        </div>
                                    @endcan
                                </div>
                ...
                {{-- @if (auth()->user()->can('users.index') || auth()->user()->can('videos.index')) --}}
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                ...
                {{-- @if (auth()->user()->can('master pelanggan.index')) --}}
                {{-- <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/customer*') ? ' active' : '' }}" href="#"
                        title="Menu Master Pelanggan" data-bs-toggle="tooltip" data-bs-trigger="hover"
                        ...
                        @can('roles.index')
                            <div class="menu-item">
                                <a class="menu-link {{ Request::is('admin/role*') ? ' active' : '' }}"
                                    ...
                                    <span class="menu-title">Group Pengguna</span>
                                </a>
                            </div>
                        @endcan
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-0">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Informasi &
                            Bantuan</span>
                    </div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-2.html">
                                ...
                                <span class="menu-title">Riwayat Aksi User</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo1/dist/layouts/toolbars/toolbar-3.html">
                                ...
                                <span class="menu-title">Riwayat Sesi User</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link" href=""
                        ...
                        <span class="menu-title">Download Wuling Android Apps</span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="../../demo1/dist/documentation/getting-started/changelog.html">
                        ...
                        <span class="menu-title">Panduan Web</span>
                    </a>
                </div>
            </div>
