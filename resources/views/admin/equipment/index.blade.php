            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="d-flex align-items-center justify-content-between mb-6">
                    <div>
                        ...
                        <span class="text-muted fs-6">Daftar Equipment</span>
                    </div>
                    <a href="{{ route('admin.equipment.create') }}" class="btn btn-primary">
                        <i class="bi bi-plus-circle me-2"></i>Tambah Equipment
                    </a>
                </div>
                {{-- ── FLASH MESSAGES ── --}}
                @if (session('success'))
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stat bg-body border-0 shadow-sm h-100">
                            <div class="card-body d-flex align-items-center p-6">
                                ...
                                <div>
                                    <div class="fw-bolder fs-2x text-gray-800" data-kt-countup="true"
                            ...
                            <form method="GET" action="{{ route('admin.equipment.index') }}" class="d-inline me-2">
                                ...
                                <div class="d-flex align-items-center position-relative">
                                    ...
                                    <input type="text" name="search"
                                        ...
                                        placeholder="Cari kode, nama, group..." value="{{ $search }}">
                                    @if ($search)
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <select name="per_page" class="form-select form-select-solid"
                                        ...
                                        @foreach ([10, 25, 50, 100] as $p)
                                            <option value="{{ $p }}"
                                                {{ request('per_page', 25) == $p ? 'selected' : '' }}>
                                                {{ $p }} data
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="table-responsive">
                            <table class="table table-row-bordered gy-4 gs-7 border rounded">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    @elseif($eq->status == 'inactive') table-danger @endif"
                                        ...
                                        @else text-gray-700 @endif">
                                            ...
                                            <td class="text-center">
                                                @if ($eq->schedule_status == 'overdue')
                                                    <span
                                                        class="badge badge-danger badge-pulse fw-bold px-3">Overdue</span>
