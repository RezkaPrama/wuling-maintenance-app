...
@endsection
@section('subtitle')
    Detail Jadwal Preventive Maintenance
@endsection
@section('menuUtama')
    Menu Utama
@endsection
...
@push('styles')
    <style>
        ...
        .countdown-box.status-overdue {
            background: linear-gradient(135deg, #ffeef3, #ffe0e8);
            border: 1px solid #f1c0cc;
        }

        .countdown-box.status-due {
            background: linear-gradient(135deg, #fff8e6, #fff3cd);
            border: 1px solid #ffd97d;
        }

        .countdown-box.status-pending {
            background: linear-gradient(135deg, #eef6ff, #ddeeff);
            border: 1px solid #b3d4f5;
        }

        .countdown-box.status-completed {
            background: linear-gradient(135deg, #efffef, #d4f5e0);
                ...
                <div class="row g-5">
                            ...
                            <div class="card-body p-0">
                                ...
                                @if ($schedule->last_maintenance && $schedule->interval_days)
                                    @php
                                        ...
                                        $cyclePct =
                                            $cycleTotal > 0 ? min(100, round(($cycleDone / $cycleTotal) * 100)) : 0;
                                    @endphp
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="val">
                                            @php
                                                ...
                                                $eqSt = $eqStMap[$schedule->equipment_status] ?? [
                                                    'class' => 'badge-light',
                                                    'label' => $schedule->equipment_status,
                                                ];
                                            @endphp
                            ...
                            <div class="card card-flush border-0 shadow-sm">
                                ...
                                <div class="card-body pt-2">
                                    @foreach ($templates as $tpl)
                                        ...
                                        @endphp
                                        <div
                                            class="d-flex align-items-start gap-3 mb-3 pb-3
                    {{ !$loop->last ? 'border-bottom' : '' }}">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex gap-2 mt-1">
                                                    <span
                                                        class="badge badge-light-primary fs-8">{{ $tpl->pm_cycle }}</span>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row g-4 mb-5">
                            @foreach ([['label' => 'Total Record', 'value' => $totalAll, 'color' => 'primary', 'icon' => 'bi-file-earmark'], ['label' => 'Selesai', 'value' => $totalDone, 'color' => 'info', 'icon' => 'bi-clipboard-check'], ['label' => 'Validated', 'value' => $totalValidated, 'color' => 'success', 'icon' => 'bi-patch-check'], ['label' => 'Rejected', 'value' => $totalRejected, 'color' => 'danger', 'icon' => 'bi-x-circle']] as $sc)
                        ...
                        <div class="card card-flush border-0 shadow-sm">
                            ...
                            <div class="card-body pt-0">
                                ...
                                @else
                                            ...
                                            <tbody>
                                                @foreach ($records as $rec)
                                                    @php
                                                        ...
                                                        if ($rec->start_time && $rec->end_time) {
                                                            $start = \Carbon\Carbon::parse(
                                                                $rec->maintenance_date . ' ' . $rec->start_time,
                                                            );
                                                            $end = \Carbon\Carbon::parse(
                                                                $rec->maintenance_date . ' ' . $rec->end_time,
                                                            );
                                                    ...
                                                    <tr class="history-row"
                                                        ...
                                                        <td class="ps-2">
                                                            <span
                                                                class="fw-bold text-primary fs-7">{{ $rec->record_number }}</span>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge {{ $rst['class'] }} fw-semibold px-2 py-1 fs-8">
                                                                <i
                                                                    class="bi {{ $rst['icon'] }} me-1"></i>{{ $rst['label'] }}
                                                            </span>
                                                        </td>
                                    ...
                                    @if ($inProgressRec)
                                        <div
                                            class="alert alert-light-warning border border-warning border-dashed d-flex gap-3 mt-4">
